...
<head>
  ...
  <title>Shampuku Ordering System : Staffs</title>
   <!-- Bootstrap -->
...
<div class="row">
 ...
 <div class="form-group">
       ...
       <div class="form-group">
          <label for="staffsname" class="col-sm-3 control-label">Sir Name</label>
          <div class="col-sm-9">
      
      <?php if($_SESSION['role'] == "Supervisor"){ ?>
      <input name="lname" type="text"class="form-control" id="staffsname" placeholder="Staff Sir Name" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_staff_lname']; ?>"required>
      <?php if($_SESSION['role'] == "Admin"){ ?>
      <input name="lname" type="text"class="form-control" id="staffsname" placeholder="Staff Sir Name" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_staff_lname']; ?>"required>
       <?php } if($_SESSION['role'] == "Normal Staff"){ ?>
          <input name="sid" type="text" class="form-control" readonly>
      ...
      <div class="form-group">
          <label for="staffgen" class="col-sm-3 control-label">Gender</label>
          <div class="col-sm-9">
         <?php if($_SESSION['role'] == "Supervisor"){ ?>
          <div class="radio">
            <label>
      <input  required name="gender" type="radio" id="staffgen" value="Male" <?php if(isset($_GET['edit'])) if($editrow['fld_staff_gender']=="Male") echo "checked"; ?>> Male
      </label>
          </div>
          <div class="radio">
            <label>
      <input  required name="gender" type="radio" id="staffgen" value="Female" <?php if(isset($_GET['edit'])) if($editrow['fld_staff_gender']=="Female") echo "checked"; ?>> Female 
        </label> 
            </div>
              <?php if($_SESSION['role'] == "Admin"){ ?>
          <div class="radio">
    ...
    <?php } if($_SESSION['role'] == "Normal Staff"){ ?>
      ...
      <div class="form-group">
          <label for="staffno" class="col-sm-3 control-label">Phone Number</label>
          <div class="col-sm-9">
       <?php if($_SESSION['role'] == "Supervisor"){ ?>
      <input name="phone" type="text"class="form-control" id="staffno" placeholder="Phone Number" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_staff_phone']; ?>"required>
        <?php if($_SESSION['role'] == "Admin"){ ?>
      <input name="phone" type="text"class="form-control" id="staffno" placeholder="Phone Number" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_staff_phone']; ?>"required>
<?php } if($_SESSION['role'] == "Normal Staff"){ ?>
          <input name="sid" type="text" class="form-control" readonly>
      ...
      <div class="form-group">
          ...
          <div class="col-sm-9">
    <?php if($_SESSION['role'] == "Supervisor"){ ?>
      <input name="email" type="text" class="form-control" id="staffemail" placeholder="Email" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_staff_email']; ?>"required>
       <?php if($_SESSION['role'] == "Admin"){ ?>
      <input name="email" type="text" class="form-control" id="staffemail" placeholder="Email" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_staff_email']; ?>"required>
...
<?php } if($_SESSION['role'] == "Normal Staff"){ ?>
        ...
        <div class="form-group">
          <label for="stafftr" class="col-sm-3 control-label">Transport : </label>
          <div class="col-sm-9">
        <?php if($_SESSION['role'] == "Supervisor"){ ?>      
      <select name="stafftr" class ="radio" required>
      <?php
      try {
      ...
      ?>
        <?php if((isset($_GET['edit'])) && ($editrow['fld_product_num']==$staffrow['fld_product_num'])) { ?>
          <option value="<?php echo $typerow['fld_product_num']; ?>" selected><?php echo $typerow['fld_product_tp'];?></option>
        <?php } else { ?>
          <option value="<?php echo $typerow['fld_product_num']; ?>"><?php echo $typerow['fld_product_tp'];?></option>
        <?php } ?>
      <?php
      } // while
      $conn = null;
      ...
      ?> 
        ...
        <?php } if($_SESSION['role'] == "Normal Staff"){ ?>
      <select name="stafftr" readonly class ="radio">
      <?php
      try {
        $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
...
<div class="row">
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      ...
      try {
        $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
          $stmt = $conn->prepare("SELECT * FROM tbl_staffs_a165731_pt2 LIMIT $start_from, $per_page");
        $stmt->execute();
        $result = $stmt->fetchAll();
      }
      catch(PDOException $e){
      ...
      <tr>
        ...
        <td><?php echo $readrow['fld_staff_tp']; ?></td>
    ...
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      <nav>
          ...
          try {
            $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
            $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
            $stmt = $conn->prepare("SELECT * FROM tbl_staffs_a165731_pt2");
            $stmt->execute();
            $result = $stmt->fetchAll();
