...
<div class="row">
 ...
 <?php if($_SESSION['role'] == "Supervisor"){ ?>
  ...
  <?php if($_SESSION['role'] == "Supervisor"){ ?>  
       <select name="brand" class="form-control" id="productbrand" required>
        ...
        <option value="Sunsilk" <?php if(isset($_GET['edit'])) if($editrow['fld_product_brand']=="Sunsilk") echo "selected"; ?>>Sunsilk</option>
        <option value="Pantene" <?php if(isset($_GET['edit'])) if($editrow['fld_product_brand']=="Pantene") echo "selected"; ?>>Pantene</option>
        <option value="Dove" <?php if(isset($_GET['edit'])) if($editrow['fld_product_brand']=="Dove") echo "selected"; ?>>Dove</option>
      </select> 
      <?php if($_SESSION['role'] == "Admin"){ ?>  
       <select name="brand" class="form-control" id="productbrand" required>
            <option value="">Please select</option>
       ...
       <?php if($_SESSION['role'] == "Normal Staff"){ ?>  
       <select name="brand" class="form-control"  readonly value=>
            <option value="">Please select</option>
        <option value="Sunsilk" <?php if(isset($_GET['edit'])) if($editrow['fld_product_brand']=="Sunsilk") echo "selected"; ?>>Sunsilk</option>
        <option value="Pantene" <?php if(isset($_GET['edit'])) if($editrow['fld_product_brand']=="Pantene") echo "selected"; ?>>Pantene</option>
        <option value="Dove" <?php if(isset($_GET['edit'])) if($editrow['fld_product_brand']=="Dove") echo "selected"; ?>>Dove</option>
 ...
 <?php } ?>
       ...
       <?php if($_SESSION['role'] == "Supervisor"){ ?>    
          <div class="radio">
            <label>
      <input name="cond" type="radio"  id="producttype" value="Conditioner" <?php if(isset($_GET['edit'])) if($editrow['fld_product_condition']=="Conditioner") echo "checked"; ?>required>> Conditioner
       </label>
          </div>
          <div class="radio">
            <label>
      <input name="cond" type="radio" id="producttype" value="Shampoo" <?php if(isset($_GET['edit'])) if($editrow['fld_product_condition']=="Shampoo") echo "checked"; ?>> Shampoo 
       </label>
          </div>
          <div class="radio">
            <label>
      <input name="cond" type="radio" id="producttype" value="Treatment Mask" <?php if(isset($_GET['edit'])) if($editrow['fld_product_condition']=="Treatment Mask") echo "checked"; ?>> Treatment Mask 
       </label>
      </div>
       <?php if($_SESSION['role'] == "Admin"){ ?>    
          <div class="radio">
  ...
  <?php if($_SESSION['role'] == "Normal Staff"){ ?>    
          <div class="radio">
            <label>
      <input name="cond" type="radio"  id="producttype" readonly> Conditioner
       </label>
          </div>
          <div class="radio">
            <label>
      <input name="cond" type="radio" id="producttype" readonly> Shampoo 
       </label>
          </div>
          <div class="radio">
            <label>
      <input name="cond" type="radio" id="producttype" readonly> Treatment Mask 
         </label>
      </div>
     ...
     <?php } ?>
        ...
        <div class="form-group">
          <label for="productvolume" class="col-sm-3 control-label">Volume (ml)</label>
          <div class="col-sm-9">
        <?php if($_SESSION['role'] == "Supervisor"){ ?> 
      <select name="volume" class="form-control" id="productvolume" required>
        <option value="250" <?php if(isset($_GET['edit'])) if($editrow['fld_product_volume']=="250") echo "selected"; ?>>250</option>
        <option value="300" <?php if(isset($_GET['edit'])) if($editrow['fld_product_volume']=="300") echo "selected"; ?>>300</option>
        <option value="400" <?php if(isset($_GET['edit'])) if($editrow['fld_product_volume']=="400") echo "selected"; ?>>400</option>
      </select> 
       <?php if($_SESSION['role'] == "Admin"){ ?> 
      <select name="volume" class="form-control" id="productvolume" required>
        <option value="250" <?php if(isset($_GET['edit'])) if($editrow['fld_product_volume']=="250") echo "selected"; ?>>250</option>
 ...
 <?php if($_SESSION['role'] == "Normal Staff"){ ?> 
      <select name="volume" class="form-control"  readonly value=>
        <option value="250" <?php if(isset($_GET['edit'])) if($editrow['fld_product_volume']=="250") echo "selected"; ?>>250</option>
        <option value="300" <?php if(isset($_GET['edit'])) if($editrow['fld_product_volume']=="300") echo "selected"; ?>>300</option>
        <option value="400" <?php if(isset($_GET['edit'])) if($editrow['fld_product_volume']=="400") echo "selected"; ?>>400</option>
      </select> 
