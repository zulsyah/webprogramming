...
<meta charset="utf-8">
  ...
  <title>Shampuku Ordering System : Orders</title>
   <!-- Bootstrap -->
...
<div class="form-group">
      ...
      <input name="oid" type="text" class="form-control" id="oid" placeholder="Order ID" readonly value="<?php if(isset($_GET['edit'])) echo $editrow['fld_order_num']; ?>" required>
        </div>
        </div>
     ...
     <div class="form-group">
      ...
      <input name="odate" type="text" class="form-control" id="orderdate" placeholder="Order Date" readonly value="<?php if(isset($_GET['edit'])) echo $editrow['fld_order_date']; ?>"> 
        </div>
        </div>
...
<div class="row">
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      ...
      try {
        $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $sql = "SELECT * FROM tbl_orders_a165731, tbl_staffs_a165731_pt2, tbl_customers_a165731_pt2 WHERE ";
        $sql = $sql."tbl_orders_a165731.fld_staff_num = tbl_staffs_a165731_pt2.fld_staff_num and ";
        $sql = $sql."tbl_orders_a165731.fld_customer_num = tbl_customers_a165731_pt2.fld_customer_num";
    ...
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      <nav>
          ...
          try {
            $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
            $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
            $stmt = $conn->prepare("SELECT * FROM tbl_orders_a165731");
            $stmt->execute();
            $result = $stmt->fetchAll();
