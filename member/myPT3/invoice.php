...
try {
  ...
  $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $stmt = $conn->prepare("SELECT * FROM tbl_order_a163776_pt2, tbl_staff_a163776_pt2,
      tbl_customer_a163776_pt2, tbl_items_a163776_pt2 WHERE
      ...
      tbl_order_a163776_pt2.fld_order_id = tbl_items_a163776_pt2.fld_order_id AND
      tbl_order_a163776_pt2.fld_order_id = :oid");
  ...
  <div class="col-xs-5">
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4>From: Heartnet's Bridal Boutique Sdn. Bhd.</h4>
      </div>
...
<table class="table table-bordered">
  ...
  <tr>
    ...
    <td class="text-right"><?php echo $detailrow['fld_items_qtt']; ?></td>
    <td class="text-right"><?php echo $detailrow['fld_price']; ?></td>
    <td class="text-right"><?php echo $detailrow['fld_price']*$detailrow['fld_items_qtt']. ".00"; ?></td>
  </tr>
  <?php
    $grandtotal = $grandtotal + $detailrow['fld_price']*$detailrow['fld_items_qtt'];
    $counter++;
  } // while
  ?>
  <tr>
    <td colspan="4" class="text-right">Grand Total</td>
    <td class="text-right"><?php echo $grandtotal. ".00" ?></td>
  </tr>
</table>
