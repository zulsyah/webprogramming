  ...
  <div class="row">
    ...
    <form action="orders.php" method="post" class="form-horizontal">
      <div class="form-group">
          ...
          <div class="col-sm-9">
      <input name="oid" type="text" class="form-control" id="orderid" placeholder="[ Auto Generated ]" readonly value="<?php if(isset($_GET['edit'])) echo $editrow['fld_order_num']; ?>">
        </div>
        </div>
      <div class="form-group">
          <label for="orderdate" class="col-sm-3 control-label">Order Date :</label>
          <div class="col-sm-9">
      <input name="orderdate" type="text" class="form-control" id="orderdate" placeholder="[ Auto Generated ]" readonly value="<?php if(isset($_GET['edit'])) echo $editrow['fld_order_date']; ?>">
        </div>
        </div>
        <div class="form-group">
    ...
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      ...
      try {
        $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $sql = "SELECT * FROM tbl_orders_a166007, tbl_staffs_a166007_pt2, tbl_customers_a166007_pt2 WHERE ";
        $sql = $sql."tbl_orders_a166007.fld_staff_num = tbl_staffs_a166007_pt2.fld_staff_num and ";
        $sql = $sql."tbl_orders_a166007.fld_customer_num = tbl_customers_a166007_pt2.fld_customer_num";
    ...
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      <nav>
          ...
          try {
            $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
            $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
            $stmt = $conn->prepare("SELECT * FROM tbl_orders_a166007 LIMIT $start_from, $per_page");
            $stmt->execute();
            $result = $stmt->fetchAll();
