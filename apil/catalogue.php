...
<div class="container-fluid"> 
  ...
  <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-10 col-md-offset-1">
      <div class="page-header">
        <h2 style="font-family: 'Segoe UI';">Product Catalogue</h2>
      </div>
      ...
      <form action="catalogue.php" method="get" >
              ...
              <div class="btn-group" style="width: 100%;">
                ...
                <?php try {
                  ...
                  $stmt = $conn->prepare("SELECT DISTINCT fld_product_type FROM tbl_products_a166007_pt2");
                ...
                <ul class="dropdown-menu" style="width: 100%;">
                  ...
                  <li><a href="catalogue.php?category=<?php echo $readrow['fld_product_type']; ?>"><?php echo $readrow['fld_product_type']; ?></a></li>
                  <?php
                    }
                    $conn = null;
                  ?>
                    ...
                    try {
                      ...
                      if(isset($_GET['search'])) {
                        ...
                        if ($getSearch == "all") {
                          ...
                          $stmt = $conn->prepare("SELECT * FROM tbl_products_a166007_pt2 WHERE fld_product_name LIKE '%".$getSearch."%'");
                        }

                      } else if(isset($_GET["category"])){
                        $getCategory = $_GET["category"];
                        $stmt = $conn->prepare("SELECT * FROM tbl_products_a166007_pt2 WHERE fld_product_type = \"".$getCategory."\"");

                      } else if (isset($_GET["sort"])) {
                        $getSort = $_GET["sort"];

                        if($getSort == "nameAsc"){
                          $stmt = $conn->prepare("SELECT * FROM tbl_products_a166007_pt2 ORDER BY fld_product_name ASC");
                        } elseif ($getSort == "nameDesc") {
                          $stmt = $conn->prepare("SELECT * FROM tbl_products_a166007_pt2 ORDER BY fld_product_name DESC");
                        } elseif ($getSort == "priceAsc") {
                          $stmt = $conn->prepare("SELECT * FROM tbl_products_a166007_pt2 ORDER BY fld_product_price ASC");
                        } elseif ($getSort == "priceDesc") {
                          $stmt = $conn->prepare("SELECT * FROM tbl_products_a166007_pt2 ORDER BY fld_product_price DESC");
                        } 
                      } else {
                        $stmt = $conn->prepare("SELECT * FROM tbl_products_a166007_pt2 LIMIT $start_from, $per_page");
                      }
