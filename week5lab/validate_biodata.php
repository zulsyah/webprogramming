...
if (isset($_POST['biodata_form'])) {
  ...
  if (isset($_POST['sex']) && ($_POST['sex'] != ""))
    ...
    $msg .= "Error: Please insert your sex.<br>";
    $count_error++;
  }
  ...
  {
    $msg .= "Error: Please insert your address.<br>";
    $count_error++;
  }
  ...
  {
    $msg .= "Error: Please insert your email.<br>";
    $count_error++;
  }
  if (isset($_POST['dob']) && ($_POST['dob'] != ""))
    $dob = $_POST['dob'];
  else{
    $msg .= "Error: Please insert your date of birthday.<br>";
    $count_error++;
  }
 if (isset($_POST['height']) && ($_POST['height'] != ""))
  ...
  {
    $msg .= "Error: Please insert your height.<br>";
    $count_error++;
  }
  ...
  {
    $msg .= "Error: Please insert your phone number.<br>";
    $count_error++;
  }
  if (isset($_POST['color']) && ($_POST['color'] != ""))
    $color = $_POST['color'];
  else{
    $msg .= "Error: Please insert your favourite color.<br>";
    $count_error++;
  }
  ...
  {
    $msg .= "Error: Please insert your FB/TW/IG URL.<br>";
    $count_error++;
  }
  ...
  {
    $msg .= "Error: Please insert your university.<br>";
    $count_error++;
  }
  ...
  {
    $msg .= "Error: Please insert your matricnum.<br>";
    $count_error++;
  }
  if ($count_error > 0) {
    echo $msg;
...
<form action="save_biodata.php" method="post">
  <table border="1" cellpadding="10">
    ...
    <tr>
      <td>My University:</td>
      <td><?php echo $univ; ?><input type="hidden" name="university" value="<?php echo $univ; ?>"></td>
    </tr>
    <tr>
