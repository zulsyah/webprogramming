...
$record = array
  (
  'name' => "Zulfhanizam Amir Syahputra",
  'age' => 21,
  'sex' => "male",
  'address' => "Kampung Apil",
  'email' => "a166007@siswa.ukm.edu.my",
  'dob' => "1998-04-23",
  'height' => 165,
  'phone' => "+6013-4946008",
  'color' => "#ccaa34",
  'fbtwig' => "https://www.facebook.com/zulsyah4",
  'univ' => "UKM",
  'matricnum' => "a166007"
  );
  ...
  <table border="1" cellpadding="10">
    ...
    <tr>
      ...
      <td>
        ...
        <input type="radio" name="sex" value="female" <?php if($record['sex'] == "female"); ?>>Female
      </td>
    </tr>
    <tr>
      <td>Address:</td>
