      ...
      <td>
        <select name="university">
          <option value="" selected>Select</option>
           <option>Universiti Putra Malaysia</option><option>Universiti Kebangsaan Malaysia</option><option>Universiti Malaya</option><option>Universiti Sains Malaysia</option> 
        </select>
      </td>
    </tr>
  </table>
