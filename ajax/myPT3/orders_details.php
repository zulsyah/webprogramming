...
<head>
  ...
  <title>SKATEBOARDS AND ROLLERBLADES : Order Details</title>
  <!-- Bootstrap -->
...
<body>
  ...
  <?php include_once 'nav_bar.php'; ?>
    ...
    try {
      ...
      $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $stmt = $conn->prepare("SELECT * FROM tbl_orders_a165959, tbl_staffs_a165959_pt2,
          tbl_customers_a165959_pt2 WHERE
  ...
  <div class="row">
    ...
    <form action="orders_details.php" method="post" class="form-horizontal" name="frmorder" id="forder">
      ...
      ?>
        <option value="<?php echo $productrow['fld_product_id']; ?>"><?php echo $productrow['fld_product_type']." ".$productrow['fld_product_name']; ?></option>
      <?php
      }
      $conn = null;
      ?>
