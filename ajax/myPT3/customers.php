...
<head>
  ...
  <title>SKATEBOARDS AND ROLLERBLADES : Customers</title>
  <!-- Bootstrap -->
  ...
  <div class="row">
    ...
    <form action="customers.php" method="post" class="form-horizontal">
      ...
      <div class="form-group">
          ...
          <div class="col-sm-9">
      <input name="phone" type="text" class="form-control" id="customerphone" placeholder="Customer Phone Number" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_customer_phonenumber']; ?>" required>
    </div>
  </div>
    ...
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      ...
      try {
        ...
        $stmt = $conn->prepare("SELECT * FROM tbl_customers_a165959_pt2 LIMIT $start_from, $per_page");
        $stmt->execute();
